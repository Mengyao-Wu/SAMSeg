...
model = dict(
    ...
    mix_style={'name': 'patchout', 'block_size': 16, "threshold": 0.5},
...
work_dir = './checkpoints/deeplabv3plus/Potsdam2Vaihingen_results/deeplabv3plus_r50-d8_4x4_512x512_40k_{}_tgt/'.format(model['mix_style']['name'])
