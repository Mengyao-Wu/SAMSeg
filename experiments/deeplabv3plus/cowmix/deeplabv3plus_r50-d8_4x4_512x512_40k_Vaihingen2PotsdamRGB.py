...
model = dict(
    ...
    mix_style={'name': 'cowmix', 'sigma': 8, "threshold": 0.5},
...
work_dir = './checkpoints/deeplabv3plus/Vaihingen2PotsdamRGB_results/deeplabv3plus_r50-d8_4x4_512x512_40k_{}/'.format(model['mix_style']['name'])
