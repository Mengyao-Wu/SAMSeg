...
if ada_super_args['mode'] == 'RA':
    ...
    work_dir = './checkpoints/deeplabv3plus/Vaihingen2Potsdam_results_ada/deeplabv3plus_r50-d8_4x4_512x512_40k_ADA_test_{}_{}_impurity/'.format(ada_super_args['ratio'], ada_super_args['pixels'])
else:
