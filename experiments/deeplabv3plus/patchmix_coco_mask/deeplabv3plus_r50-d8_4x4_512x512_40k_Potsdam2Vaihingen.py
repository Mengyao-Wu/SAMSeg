...
work_dir = './checkpoints/deeplabv3plus/Potsdam2Vaihingen_results/deeplabv3plus_r50-d8_4x4_512x512_40k_{}_coco_mask/'.format(model['mix_style']['name'])
# work_dir = './checkpoints/deeplabv3plus/Potsdam2Vaihingen_results/deeplabv3plus_r50-d8_4x4_512x512_40k_{}_coco_mask_test/'.format(model['mix_style']['name'])
