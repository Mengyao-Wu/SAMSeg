_base_ = [
    '../../../configs/_base_/datasets/GR_daseg.py', '../../../configs/_base_/default_runtime.py',
]
# model settings
...
model = dict(
    ...
    decode_head_s=dict(
        ...
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, class_weight=[1.5, 1.0, 2.5, 1.25])),
    decode_head_t=dict(
        type='SegformerHead',
        in_channels=[64, 128, 320, 576],
        in_index=[0, 1, 2, 3],
...
work_dir = './experiments/segformerb5/results_R2G/'
...
data = dict(
    ...
    workers_per_gpu=3,
    train=dict(
        img_dir='2021LoveDA_RuralforGF-2_5CLS/Rural_train/images_png',
        ann_dir='2021LoveDA_RuralforGF-2_5CLS/Rural_train/masks_png_5CLS', 
        split='2021LoveDA_RuralforGF-2_5CLS/TrainRural.txt',
        B_img_dir = 'GID_G2R/img_dir',
        B_split = 'GID_G2R/train.txt'),
    # target domain for validation
    val=dict(
        img_dir='GID_G2R/img_dir',
        ann_dir='GID_G2R/ann_dir', 
        split='GID_G2R/val.txt'),
    test=dict(
        img_dir='GID_G2R/img_dir',
        ann_dir='GID_G2R/ann_dir', 
        split='GID_G2R/val.txt'))
