...
def convert_mit(ckpt):
    ...
    for k, v in ckpt.items():
        ...
        # patch embedding conversion
            ...
            ## modified by LYU: 2022/3/10 issue #1343
            #new_k = k.replace(f'patch_embed{stage_i}', f'backbone.layers.{stage_i-1}.0')
            new_v = v
            if 'proj.' in new_k:
        ...
        # transformer encoder layer conversion
            ...
            ## modified by LYU: 2022/3/10 issue #1343
            #new_k = k.replace(f'block{stage_i}', f'backbone.layers.{stage_i-1}.1')
            new_v = v
            if 'attn.q.' in new_k:
        ...
        # norm layer conversion
            ...
            ## modified by LYU: 2022/3/10 issue #1343
            #new_k = k.replace(f'norm{stage_i}', f'backbone.layers.{stage_i-1}.2')
            new_v = v
        else:
            new_k = k
            new_v = v
